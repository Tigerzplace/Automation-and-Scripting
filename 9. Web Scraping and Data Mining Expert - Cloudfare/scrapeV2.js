// List of 50 User-Agents to rotate
var userAgents = [
  ...
  function getVehicleDetails(plate, retries = 3) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        ...
        } else if (xhr.status >= 400 && retries > 0) {
          console.log(`Retrying... attempts left: ${retries - 1}`);
          setTimeout(() => getVehicleDetails(plate, retries - 1), 1000 + Math.random() * 1000);
        } else {
          console.error(`Failed to fetch vehicle details after multiple attempts. Status: ${xhr.status}`);
        }
      }
    };
  ...
  setTimeout(() => getVehicleDetails("AAA123"), Math.random() * 2000 + 1000); // Initial delay between 1-3 seconds
